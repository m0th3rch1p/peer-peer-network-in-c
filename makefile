...
server_debug:
	gcc -g "./dataStructures/node/node.c" "./dataStructures/lists/linkedList.c" "./dataStructures/queues/queue.c" "./dataStructures/trees/binaryTree.c" "./dataStructures/dictionaries_tree/dictionary.c" "./networking/protocols/HTTPRequest.c" "./networking/nodes/server.c" source.c -o source